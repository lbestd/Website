...
def setup_routes(app):
    ...
    app.router.add_get("/game", views.game)
    app.router.add_get("/game/webgl", views.game_webgl)
    app.router.add_get("/game/rs", views.game_rs)
    app.router.add_get("/game/bench", views.game_bench)
    app.router.add_static('/game/pkg/', BASE_DIR / 'game' / 'pkg')
